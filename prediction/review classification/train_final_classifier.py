...
num_epochs = 10
num_hidden = 512  # Number of hidden neurons in model
...
optimizer = torch.optim.Adam(model.parameters(), lr=0.0005, betas=(0.9, 0.999), eps=1e-08, weight_decay=0,amsgrad=True)
